...
namespace GestionClientesAPI.Recursos
{
    public class DBConexion
    {
        public static string cadenaConexion = "Server = DESKTOP-NPFL5BR; Database=GestionClientes; Trusted_Connection = true;TrustServerCertificate=true";
